...
fun KotlinMultiplatformExtension.kotlinWasmTargets() {
    wasmJs {
        useEsModules()
        browser {
            testTask {
...
const val kiluaRpcProjectName = "Kilua Gettext"
const val kiluaRpcProjectDescription = "Gettext library for Kotlin/Wasm and Kotlin/JS web applications"
const val kiluaRpcUrl = "https://github.com/rjaros/kilua-gettext"
const val kiluaRpcVcsUrl = "scm:git:git://github.com/rjaros/kilua-gettext.git"
